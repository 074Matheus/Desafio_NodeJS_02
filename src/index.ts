...
app.listen(PORT, () => {
	...
	console.log('O aluno0dos alunos é')
	...
	if (dev1) {
		console.log(`${aluno01} é dev`)
	}else{
		console.log(`${aluno01} não é dev`)
	}
	if (dev2) {
		console.log(`${aluno02} é dev`)
	} else {
		console.log(`${aluno02} não é dev`)
	}
	if (dev3) {
		console.log(`${aluno03} é dev`)
	} else {
		console.log(`${aluno03} não é dev`)
	}
